...
export default function CoupleGuests() {
  ...
  // --- Seating state (kept for backward compatibility) ---
  ...
  // ======== Seating Table CRUD (kept for refetching from other tabs) ========
  ...
  // ======== Guest Reassignment (kept for backward compat) ========
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ======== SEATING TAB ======== */}
      {activeTab === 'seating' && (
        <CoupleSeatingCanvas onAddTable={handleAddTable} />
      )}
