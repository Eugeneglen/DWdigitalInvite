  ...
  try {
    ...
    return NextResponse.json({
      wedding: {
        ...
        heroVideoUrl,
        bannerUrl,
        // Mobile hero framing (additive — null/absent = legacy centre-crop fill)
        heroFocalX: wedding.heroFocalX ?? null,
        heroFocalY: wedding.heroFocalY ?? null,
        heroDisplayMode: wedding.heroDisplayMode ?? null,
      },
      content: contentMap,
